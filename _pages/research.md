...
<style>
  ...
  html[data-theme="dark"] .research-heading {
    border-bottom-color: rgba(216, 181, 104, 0.25);
  }
  html[data-theme="dark"] .research-details > summary {
    color: #d8b568;
  }
</style>
...
<summary>Click to see details and papers in this topic</summary>
...
### Reinforcement Learning and Control for Networked Systems
{: .research-heading}
...
- Xin Chen, Guannan Qu, Yujie Tang, Steven Low, Na Li, Reinforcement Learning for Selective Key Applications in Power Systems: Recent Advances and Future Challenges, accepted to IEEE Transactions on Smart Grid. ([link](https://arxiv.org/abs/2102.01168))
- Yuanyuan Shi*, Guannan Qu*, Steven Low, Anima Anandkumar, Adam Wierman, Stability Constrained Reinforcement Learning for Real-Time Voltage Control , American Control Conference 2022. (* denotes equal contribution) ([link](https://arxiv.org/abs/2109.14854))
